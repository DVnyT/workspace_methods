...
def benchmark_DMRG(max_chi=200, use_Sz=False):
    ...
    model_params = {
        ...
        #
        # The following 'sort_mpo_legs' parameter makes the MPO
        # "dense" in that the quantum number related blocks are
        # as large as possible by symmetry. (The default behavior
        # of ITensor's AutoMPO/OpSum system as of version 0.2.26.)
        #
        'sort_mpo_legs': True,
    }
